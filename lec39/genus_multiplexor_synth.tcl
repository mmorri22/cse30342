...
set DESIGN multiplexor
set GEN_EFF medium
set MAP_OPT_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH ../risc/outputs_${DESIGN}
set _REPORTS_PATH ../risc/reports_${DESIGN}
...
##set_db / .hdl_unconnected_vmultiplexore 0 | 1 | x | none
...
read_hdl ../Verilog/${DESIGN}.v ../Verilog/tutorial.v -define USE_CASE
elaborate $DESIGN
...
## ungroup -threshold <vmultiplexore>
